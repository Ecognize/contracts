    ...
    \begin{paracol}{3}
      ...
      \clause
        ...
        { \subsection{Припинення повноважень правління}
          ...
          Призначити членами правління осіб, визначених у \smartref{app:management}{додатку } безстроково із наступного календарного дня після дня проведення цього Зібрання.
        }
