...
\newcommand\votebox[4]{\begin{tabular}{r l}\voteline{#2}{#1yes}\voteline{#3}{#1no}\voteline{#4}{#2abs}\end{tabular}}
  ...
  \begin{Form}
    ...
    \begin{paracol}{3}
      ...
      \clause
        ...
        {The meeting was attended by \fieldw{participantsET}{25} participants (\smartref{app:attend}{appendix }), who represent \fieldw{votesET}{25}\% of voting rights. Therefore the Meeting has reached a quorum.}
      ...
      \clause
        ...
        {Agenda}
        {Päevakord}
        { \subsection{Зупинення складу правління}
          Визнати нечинним склад поточний склад правління, що був ухвалений у:\\
          \fieldline{previous1UK}\\
          \fieldline{previous2UK}\\
          датованому(-ій):\\
          \fieldline{previousdateUK}
          \subsection{Призначення нового складу правління}
          Призначити до складу правління осіб, визначених у \smartref{app:management}{додатку } безстроково із наступного календарного дня після для проведення цього Зібрання.
        }
        { \subsection{Suspension of the management board}
          Suspend the current management board members which were elected by:\\
