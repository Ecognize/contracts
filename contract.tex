  ...
  \begin{Form}
    ...
    \begin{paracol}{3}
      ...
      \clause
        ...
        {Dispute resolution}
        {}
        {У\fauxsc{года} укладена у відповідності до законодавства України та Естонської Республіки. С\faux{торони} визначають юрисдикцію суду повіту Гар'юмаа для вирішення конфліктних ситуацій.}
      ...
      \clause
        ...
        {Duration}
        {Eesti}
        {У\fauxsc{года} укладається \fauxsc{сторонами} із строком дії у \fieldw{duration}{75} рік(-и,-ів). Якщо \fauxsc{замовник} на дату закінчення дії \fauxsc{угоди} продовжує потребувати послуг від \fauxsc{виконавця}, \fauxsc{сторони} мають укласти нову \fauxsc{угоду}.}
        {The \textsc{agreement} is concluded by the \textsc{parties} for the duration of \fieldw{duration}{75} year(s). Should the \textsc{customer} require further service on the \textsc{provider}'s behalf, a new \textsc{agreement} \emph{shall} be concluded.}
        {}
      \clause
        {Припинення дії}
        {Termination}
